...
const CollectionPage = () => {
    ...
    useEffect(() => {
        axios(`https://613fef235cb9280017a110a6.mockapi.io/products?collectionId=${id}`)
            .then(({data}) => {
    ...
    return (
        <div className="container">
            <div className='collectingPage'>
                <h2 className="collectingPage__title">Коллекция зима 2020</h2>
                <div className="row">
                    {
                        collectionsProduct.map(item =>
                            <div className="col-lg-3 col-md-4 col-sm-6 col-card" key={item.id}>
                                <div className='card'>
                                    <div>
                                        <Swiper
